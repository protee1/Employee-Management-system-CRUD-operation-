...
import com.softech.netika.service.EmployeeService;
...
public String ShowNewEployeeForm(Model model) {
...
public String showormUpdate(@PathVariable(value = "id")long id,Model model) {
